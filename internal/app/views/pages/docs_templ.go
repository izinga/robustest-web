...
func DocsPage(page *docs.Page, nav *docs.Nav, currentPath string, prev *docs.NavLink, next *docs.NavLink) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "\"><meta name=\"theme-color\" media=\"(prefers-color-scheme: light)\" content=\"#f4f7f9\"><meta name=\"theme-color\" media=\"(prefers-color-scheme: dark)\" content=\"#0c1318\"><link rel=\"preconnect\" href=\"https://fonts.googleapis.com\"><link rel=\"preconnect\" href=\"https://fonts.gstatic.com\" crossorigin><link href=\"https://fonts.googleapis.com/css2?family=Schibsted+Grotesk:wght@500;600;700;800&family=Inter:wght@400;500;600&family=IBM+Plex+Mono:wght@400;500&display=swap\" rel=\"stylesheet\"><link rel=\"icon\" type=\"image/png\" href=\"/assets/images/favicon.png\"><link rel=\"stylesheet\" href=\"/assets/css/app.css\"><!-- Self-hosted GoatCounter (first-party ground-truth analytics) --><script data-goatcounter=\"https://robustest.com/gc/count\" async src=\"/assets/js/count.js\"></script></head><body class=\"bg-paper text-ink font-sans\"><header class=\"sticky top-0 z-50 bg-paper/90 backdrop-blur-sm border-b border-line\"><div class=\"max-w-[88rem] mx-auto px-4 sm:px-6 flex items-center justify-between h-14\"><div class=\"flex items-center gap-3 min-w-0\"><a href=\"/\" class=\"inline-flex items-center shrink-0\" aria-label=\"RobusTest home\"><img src=\"/assets/images/logo-full.png\" alt=\"RobusTest\" class=\"brand-logo h-5 w-auto\"></a> <span class=\"w-px h-5 bg-line-strong\" aria-hidden=\"true\"></span> <a href=\"/docs\" class=\"font-mono text-xs uppercase tracking-widest text-muted hover:text-ink\">Docs</a><div class=\"hidden md:block relative w-64 ml-4\"><input type=\"search\" id=\"docs-search\" placeholder=\"Search docs…\" autocomplete=\"off\" class=\"w-full bg-surface border border-line px-3 py-1.5 text-sm text-ink placeholder:text-muted\" aria-label=\"Search documentation\"> <kbd class=\"absolute right-2.5 top-1/2 -translate-y-1/2 font-mono text-[10px] text-muted border border-line px-1 py-0.5 pointer-events-none\">⌘K</kbd><div id=\"docs-search-results\" class=\"hidden absolute top-full left-0 right-0 mt-1 bg-surface border border-line-strong shadow-xl shadow-ink/10 max-h-80 overflow-y-auto z-50\"></div></div></div><nav class=\"flex items-center gap-5\"><a href=\"/features\" class=\"hidden sm:inline text-sm font-medium text-muted hover:text-ink\">Platform</a> <a href=\"/contact\" class=\"bg-signal text-paper px-3 py-1.5 text-sm font-semibold hover:opacity-90 transition-opacity\">Book a demo</a></nav></div></header><div class=\"max-w-[88rem] mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-[16rem_minmax(0,1fr)_12rem] gap-8\"><!-- sidebar --><aside class=\"lg:sticky lg:top-14 lg:h-[calc(100vh-3.5rem)] lg:overflow-y-auto py-6 lg:py-10 border-b lg:border-b-0 border-line\"><details class=\"lg:hidden mb-2\"><summary class=\"font-mono text-xs uppercase tracking-widest text-signal cursor-pointer py-1\">Menu</summary>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		if prev != nil || next != nil {
			...
			if prev != nil {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/views/pages/docs.templ`, Line: 74, Col: 63}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/views/pages/docs.templ`, Line: 76, Col: 107}
				}
			...
			if next != nil {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/views/pages/docs.templ`, Line: 82, Col: 63}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/views/pages/docs.templ`, Line: 84, Col: 107}
				}
		...
		if len(page.TOC) > 0 {
			...
			for _, item := range page.TOC {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/views/pages/docs.templ`, Line: 98, Col: 45}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/views/pages/docs.templ`, Line: 100, Col: 21}
				}
	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, section := range nav.Sections {
			...
			if section.Title != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/views/pages/docs.templ`, Line: 130, Col: 38}
				}
			...
			for _, link := range section.Links {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/views/pages/docs.templ`, Line: 136, Col: 60}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/views/pages/docs.templ`, Line: 138, Col: 20}
				}
